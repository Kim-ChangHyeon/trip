	...
	<script src="./summernote/summernote.min.js"></script>
				...
				<c:if test="${location eq 'seoul'}">서울</c:if>
      			...
      			글쓰기</h1>
					<form>
						...
						테마 : <input type="text" id="locationName" name="locationName" placeholder="지역을 입력하세요.">
				...
				$(document).ready(function() {$('#summernote').summernote({height : 500});});
					...
					form.onsubmit = function() {
						...
						if(location.value == null || location.value.length < 2) {
							alert("지역를 입력하세요.");
							location.focus();
							return false;
						}
