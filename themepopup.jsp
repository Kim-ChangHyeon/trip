...
<body>
	...
	<div id="popup">
  	<div>
	  	...
	  	<c:if test="${grade eq 1 }"><img id="delete" src="./img/delete.png" onclick="return del(${detail.theme_no})"></c:if>
	  		<h1 id="title">${detail.theme_title }</h1>
	  		<hr>
	  		
	  		<div class="popup_addr">
	  		<span>Location ${detail.theme_theme }</span>
	  		</div>
	...
	<div class="slidewrap">
		...
		<ul class="slidelist">
			...
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file1 }">
				</a>
			</li>
			<c:if test="${detail.theme_file2 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file2 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file3 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file3 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file4 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file4 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file5 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file5 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file6 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file6 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file7 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file7 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file8 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file8 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file9 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file9 }">
				</a>
			</li>
			</c:if>
			<c:if test="${detail.theme_file10 ne null}">
			<li class="slideitem">
				<a>
					<img src="./upload/${detail.theme_file10 }">
				</a>
			</li>
			</c:if>
			<!-- 좌,우 슬라이드 버튼 -->
			<div class="slide-control">
				<div>
					...
					<c:if test="${detail.theme_file2 eq null }">
					<label for="slide${imgtotal }" class="left"></label>
				...
				<div>
					...
					<c:if test="${detail.theme_file3 eq null }">
					<label for="slide01" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file4 eq null }">
					<label for="slide02" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file5 eq null }">
					<label for="slide03" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file6 eq null }">
					<label for="slide04" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file7 eq null }">
					<label for="slide05" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file8 eq null }">
					<label for="slide06" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file9 eq null }">
					<label for="slide07" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
				...
				<div>
					...
					<c:if test="${detail.theme_file10 eq null }">
					<label for="slide08" class="left"></label>
					<label for="slide01" class="right"></label>
					</c:if>
			...
			<ul class="slide-pagelist">
				...
				<c:if test="${detail.theme_file2 ne null}"><li><label for="slide02"></label></li></c:if>
				<c:if test="${detail.theme_file3 ne null}"><li><label for="slide03"></label></li></c:if>
				<c:if test="${detail.theme_file4 ne null}"><li><label for="slide04"></label></li></c:if>
				<c:if test="${detail.theme_file5 ne null}"><li><label for="slide05"></label></li></c:if>
				<c:if test="${detail.theme_file6 ne null}"><li><label for="slide06"></label></li></c:if>
				<c:if test="${detail.theme_file7 ne null}"><li><label for="slide07"></label></li></c:if>
				<c:if test="${detail.theme_file8 ne null}"><li><label for="slide08"></label></li></c:if>
				<c:if test="${detail.theme_file9 ne null}"><li><label for="slide09"></label></li></c:if>
				<c:if test="${detail.theme_file10 ne null}"><li><label for="slide10"></label></li></c:if>
			</ul>
		</div>
 ...
 <script>
  function closed() {
  		location.href="./theme?theme=${theme}&limit=${limit}&page=${page }&on=${on }&view=${view }";
  	}
  function del(num){
  	var check = confirm("게시물을 삭제하시겠습니까?");
  	if(check == true){
  		alert(num + "번 게시물을 삭제합니다.");
  		location.href="themedelete?theme=${theme}&bno="+num;
  	} else{
  		alert("삭제를 취소하였습니다.");
  		return false;
  	}
