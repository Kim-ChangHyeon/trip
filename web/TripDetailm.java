...
@WebServlet("/tripdetailm")
public class TripDetailm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		if(request.getParameter("cno") != null) {
			cno = NumberCheck.number(request.getParameter("cno"));
		}
		...
		request.setAttribute("comcno", cno);
		RequestDispatcher rd = request.getRequestDispatcher("./tripdetailm.jsp");
