...
function del(num){
	...
	if(check == true){
		...
		location.href="tripdelete?bno="+num;
	} else{
		alert("삭제를 취소하였습니다.")
		return false;
	}
    ...
    <div class="location"> 
			...
			<div id="main">
				<table id="detail">	
					...
					<c:if test="${detail.rfile1 ne null }"><img alt="1" src="./upload/${detail.rfile1 }" style="max-width: 728px; max-height: 455px;"><BR></b></c:if>
					<c:if test="${detail.rfile2 ne null }"><img alt="2" src="./upload/${detail.rfile2 }" style="max-width: 728px; max-height: 455px;"><BR></c:if>
					<c:if test="${detail.rfile3 ne null }"><img alt="3" src="./upload/${detail.rfile3 }" style="max-width: 728px; max-height: 455px;"><BR></c:if>
					<c:if test="${detail.rfile4 ne null }"><img alt="4" src="./upload/${detail.rfile4 }" style="max-width: 728px; max-height: 455px;"><BR></c:if>
					<c:if test="${detail.rfile5 ne null }"><img alt="5" src="./upload/${detail.rfile5 }" style="max-width: 728px; max-height: 455px;"><BR></c:if>
				...
				<div class="commentList">
					...
					<span class="update">
						<a href="./tripdetailm?bno=${co.rno }&cno=${co.cno}" style="position: relative;left: 80%;">수정</a> &nbsp;
